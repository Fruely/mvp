...
const STEPS = [
  { number: 1, icon: Search, titleKey: "home.variantB.howItWorks.step1.title", bodyKey: "home.variantB.howItWorks.step1.description" },
  { number: 2, icon: Users, titleKey: "home.variantB.howItWorks.step2.title", bodyKey: "home.variantB.howItWorks.step2.description" },
  { number: 3, icon: Mail, titleKey: "home.variantB.howItWorks.step3.title", bodyKey: "home.variantB.howItWorks.step3.description" },
] as const;

export default function VariantBHowItWorksSteps({ dict }: { dict: Dictionary }) {
  return (
