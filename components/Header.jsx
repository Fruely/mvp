      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/about" className="text-gray-700 hover:text-primary">О нас</Link>
            <Link href="/contacts" className="text-gray-700 hover:text-primary">Контакты</Link>
          </nav>

          <div className="flex items-center gap-4">
            <div className="hidden sm:flex items-center gap-2">
              <div className="text-sm text-gray-600 mr-2">{/* question text */}Bist du Fachkraft?</div>
              <Link href="/specialist" className="px-4 py-2 rounded-full bg-primary text-white text-sm font-semibold hover:shadow-lg transform hover:scale-105 transition">
