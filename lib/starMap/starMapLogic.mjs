...
/** Geographic bounds for the Figma Europe background (850×680 viewBox). */
export const EUROPE_STAR_MAP_BOUNDS = {
  latMin: 47.5,
  latMax: 55,
  lngMin: -6,
  lngMax: 18.5,
...
/** Figma Europe context map viewBox (node 268:2). */
export const EUROPE_STAR_MAP_VIEWBOX = {
  width: 850,
  height: 680,
};
