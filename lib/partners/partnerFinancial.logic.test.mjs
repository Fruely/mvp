...
} from "./partnerFinancialAvailability.ts";
...
test("AF/AG/AH/AI/AJ: existing partner regression modules still import", async () => {
  await import("./commissionValidation.ts");
  await import("./rewardCalculation.ts");
  await import("../../lib/billing/stripePartnerCommission.ts");
});
