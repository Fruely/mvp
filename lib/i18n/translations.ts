...
export const specialistPageTranslations: Record<string, Translations> = {
  ua: {
    ...
    servicesAndPricesTitle: "Послуги та ціни",
    ...
    locationSectionTitle: "Розташування",
    ...
    newBadge: "Новий",
    cofounderBadge: "Співвласник Freuly",
  ...
  ru: {
    ...
    servicesAndPricesTitle: "Услуги и цены",
    ...
    locationSectionTitle: "Расположение",
    contactsLineLanguages: "Языки",
    contactsLineFormat: "Формат работы",
    work_format: { online: "Онлайн", offline: "Офлайн", hybrid: "Онлайн • Офлайн" },
    readMore: "Читать полностью",
    newBadge: "Новый",
    cofounderBadge: "Совладелец Freuly",
  ...
  de: {
    ...
    servicesAndPricesTitle: "Leistungen und Preise",
    ...
    newBadge: "Neu",
    cofounderBadge: "Mitinhaber von Freuly",
  ...
  en: {
    ...
    servicesAndPricesTitle: "Services and prices",
    servicesSubtitle: "",
    ...
    readMore: "Read more",
    newBadge: "New",
    cofounderBadge: "Freuly Co-founder",
