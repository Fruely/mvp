...
import { assistedPrefillToRequestHref, requestServiceHref } from "../serviceRequests/requestServiceHref.ts";
...
test("buildCategorySearchHref deep-links into contextual search", () => {
  assert.equal(
    buildCategorySearchHref("ua", "it-support"),
    "/specialists?lang=uk&category=it-support",
  );
  assert.equal(
