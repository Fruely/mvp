...
test("uiLang is stamped as ui= without replacing service-language lang", () => {
...
test("omitting uiLang does not invent a ui query param (legacy URLs)", () => {
  const url = buildServiceSearchResultsUrl({
    service: "перевод документов",
    language: "ua",
    format: "online",
