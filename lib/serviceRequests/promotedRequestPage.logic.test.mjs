...
import { resolveSpecialistEntitlements } from "../billing/planEntitlements.ts";
...
test("basic + early_access stays locked via resolveSpecialistEntitlements", () => {
...
test("basic + active unlocks via resolveSpecialistEntitlements", () => {
  const entitlements = resolveSpecialistEntitlements({
    plan_code: "basic",
    plan_status: "active",
  });
