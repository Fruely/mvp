...
export default async function RetreatsPage({
  ...
  const { data } = await supabase
    ...
    .or(retreatsContent.filterOr ?? "")
    .limit(12);

  return (
    <CategoryContentPage
      lang={lang}
      content={retreatsContent.content[lang]}
      specialists={data ?? []}
    />
  );
}
