    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 409) {
          errorMessage =
            "Специалист с таким email уже зарегистрирован. Используйте другой email или войдите в существующий аккаунт.";
        } else if (response.status === 404) {
          errorMessage =
            "Выбранная категория не найдена. Пожалуйста, выберите категорию из списка.";
        }
