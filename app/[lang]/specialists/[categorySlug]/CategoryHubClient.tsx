...
function normalizeSpecialistPreview(input: any): SpecialistPreview | null {
  ...
  return {
    ...
    pricing_exception:
      input.pricing_exception === "THIRD_PARTY_FUNDED" || input.pricing_exception === "AFTER_ASSESSMENT"
        ? input.pricing_exception
        : null,
        ...
        <div className="space-y-freuly-6">
          ...
          {!loadingSpecialists && specialists.length === 0 ? (
            <ServiceRequestCtaBlock
              ...
              sourcePath={`${langPrefix}/specialists/${slug}`}
              prefill={{
                category_text: categoryLabel,
                source_path: `${langPrefix}/specialists/${slug}`,
