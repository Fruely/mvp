  ...
  <p>Если у вас есть вопросы, напишите на <a href="mailto:freuly.de@gmail.com">freuly.de@gmail.com</a></p>
    ...
    const { data: newSpecialist, error: createError } = await supabase
      ...
      .insert({
        ...
        terms_version: app.terms_version || null,
        specialist_rules_accepted_at: app.specialist_rules_accepted_at || null,
        specialist_rules_version: app.specialist_rules_version || null,
      })
      .select()
      .single();
