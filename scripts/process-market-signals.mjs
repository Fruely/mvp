...
function detectCity(text) {
  const cities = [
    ...
    { slug: 'essen', value: 'Essen', aliases: ['essen', 'эссен', 'ессен'] },
    { slug: 'dortmund', value: 'Dortmund', aliases: ['dortmund', 'дортмунд'] },
    { slug: 'duisburg', value: 'Duisburg', aliases: ['duisburg', 'дуйсбург', 'дюйсбург'] },
    { slug: 'bochum', value: 'Bochum', aliases: ['bochum', 'бохум'] },
    { slug: 'wuppertal', value: 'Wuppertal', aliases: ['wuppertal', 'вупперталь'] },
    { slug: 'bielefeld', value: 'Bielefeld', aliases: ['bielefeld', 'билефельд', 'білефельд'] },
    { slug: 'münster', value: 'Münster', aliases: ['münster', 'muenster', 'мюнстер'] },
    { slug: 'aachen', value: 'Aachen', aliases: ['aachen', 'ахен', 'аахен'] },
    { slug: 'gelsenkirchen', value: 'Gelsenkirchen', aliases: ['gelsenkirchen', 'гельзенкирхен'] },
    { slug: 'mönchengladbach', value: 'Mönchengladbach', aliases: ['mönchengladbach', 'moenchengladbach', 'мёнхенгладбах', 'менхенгладбах'] },
    { slug: 'oberhausen', value: 'Oberhausen', aliases: ['oberhausen', 'оберхаузен'] },
    { slug: 'hagen', value: 'Hagen', aliases: ['hagen', 'хаген'] },
    { slug: 'hamm', value: 'Hamm', aliases: ['hamm', 'хамм'] },
    { slug: 'krefeld', value: 'Krefeld', aliases: ['krefeld', 'крефельд'] },
    { slug: 'leverkusen', value: 'Leverkusen', aliases: ['leverkusen', 'леверкузен'] },
    { slug: 'solingen', value: 'Solingen', aliases: ['solingen', 'золинген', 'солинген'] },
    { slug: 'remscheid', value: 'Remscheid', aliases: ['remscheid', 'ремшайд'] },
    { slug: 'neuss', value: 'Neuss', aliases: ['neuss', 'нойс'] },
    { slug: 'paderborn', value: 'Paderborn', aliases: ['paderborn', 'падерборн'] },
    { slug: 'siegen', value: 'Siegen', aliases: ['siegen', 'зиген', 'зіген'] },
    { slug: 'bergisch-gladbach', value: 'Bergisch Gladbach', aliases: ['bergisch gladbach', 'bergisch-gladbach', 'бергиш гладбах'] },
